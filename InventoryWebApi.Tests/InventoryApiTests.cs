...
namespace InventoryWebApi.Tests
{
    public class InventoryApiTests : IClassFixture<WebApplicationFactory<Program>>
    {
        ...
        public async Task TestCase0()
        {
            ...
            var response0 = await Client.PostAsync("/inventory/item", new StringContent(JsonConvert.SerializeObject(createForm0), Encoding.UTF8, "application/json"));
            response0.StatusCode.Should().BeEquivalentTo(HttpStatusCode.Created);
            ...
            var response1 = await Client.PostAsync("/inventory/item", new StringContent(JsonConvert.SerializeObject(createForm1), Encoding.UTF8, "application/json"));
            response1.StatusCode.Should().BeEquivalentTo(HttpStatusCode.Created);
        ...
        public async Task TestCase1()
        {
            ...
            response0.StatusCode.Should().BeEquivalentTo(HttpStatusCode.OK);
        ...
        public async Task TestCase6()
        {
            ...
            response0.StatusCode.Should().BeEquivalentTo(HttpStatusCode.NotFound);
        ...
        private void SetUpClient()
        {
            ...
            Client = _factory.WithWebHostBuilder(builder =>
                builder.UseStartup<InventoryWebApi.Startup>()
